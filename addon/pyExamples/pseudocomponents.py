...
# Recreate the same mixture using pseudo functionality. Two initializations required:
# The first one tells thermopack which components are pseudocomponents.
# The second initializes the pseudocomponents using Tc, Pc, acf, Mw. The real components are left untouched.
# NB: Ideal gas heat capacities are not implemented for pseudocomponents, so only residual caloric properties are available.
